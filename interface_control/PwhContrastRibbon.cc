...
{
    connect(import_file_, &RibbonTool::clicked, this, &PwhContrastRibbon::importAnalysisFile);
    connect(up_chart_, &RibbonTool::clicked, this, &PwhContrastRibbon::upChart);
    connect(down_chart_, &RibbonTool::clicked, this, &PwhContrastRibbon::downChart);
    connect(export_pdf_, &RibbonTool::clicked, this, &PwhContrastRibbon::exportPDF);
